...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    # 1. Calculate the actual rate including the spread percentage fee
    actual_rate = exchange_rate * (1 + spread / 100)
        # 2. Get total possible raw foreign currency
    total_new_currency = budget / actual_rate
    
    # 3. Floor to the nearest full denomination bill and return as an int
