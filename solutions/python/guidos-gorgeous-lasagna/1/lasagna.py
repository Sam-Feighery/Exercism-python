...
EXPECTED_BAKE_TIME = 40 # Baking time in minutes 
PREPARATION_TIME = 2 # Time to make one layer of the lasagna 
...
#Function that calculates the lasanga preparation time
def prepareation_time_in_minutes(number_of_layers):
