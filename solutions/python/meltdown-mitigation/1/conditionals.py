...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    1# Calculates the total output of the reactor 
    total_output = temperature * neutrons_produced_per_second
    2# Define the treathold of the reactor 
    low_point = threshold * 0.9
    high_point = threshold * 1.10
    3# Calculate the reactors condition
    if total_output < low_point:
        return 'LOW'
    if low_point <= total_output <= high_point:
        return 'NORMAL'
    return 'DANGER'
